CREATE DATABASE  IF NOT EXISTS `vacation_module` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `vacation_module`;
-- MySQL dump 10.13  Distrib 5.7.9, for osx10.9 (x86_64)
--
-- Host: db.bexio.dev    Database: vacation_module
-- ------------------------------------------------------
...
INSERT INTO `users` VALUES (1,'john_doe','2017-07-23 17:28:41','John','Doe'),(2,'jane_doe','2017-07-23 17:28:56','Jane','Doe');
...
CREATE TABLE `vacation_days` (
  ...
  CONSTRAINT `vacation_days_FK_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vacation_days` VALUES (1,1,20),(2,2,20);
...
CREATE TABLE `vacation_requests` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `requested_days` int(11) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_user_id_idx` (`user_id`),
  CONSTRAINT `vacation_request_FK_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
-- Dump completed on 2017-07-24 18:07:14
